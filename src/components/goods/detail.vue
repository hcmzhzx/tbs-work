   ...
   <div id="detail" class="flexv">
      ...
      <div id="main" class="flexitemv">
         ...
         <div id="card" class="flexv" v-if="vip">
            <div class="flex info">
               <a :href="`tel:${user.phone}`" class="flex center phone"><i class="flex center rd rd-phone"></i><span>拨打电话</span></a>
               ...
               <div class="flexitemv name">
                  ...
                  <a href="javascript:;" class="flex" @click="qq=true"><i class="rd rd-qq"></i><span>{{qqnum}}</span></a>
                  <a href="javascript:;" class="flex" @click="wechatNum=true"><i class="rd rd-weixin"></i><span>{{user.wechat}}</span></a>
               </div>
            </div>
            <div class="flex link">
               <a href="javascript:;" @click="$router.push({name:'index'})" class="flexitem center"><i class="rd rd-home"></i><span>Ta的工作室</span></a>
               <a :href="`http://${partner.fg_domain}`" class="flexitem center"><i class="rd rd-mingpian"></i><span>我也要工作室？</span></a>
            </div>
         </div>
      </div>
      ...
      <a href="javascript:;" id="qrcodebor" v-if="vip" @click="wechatQrcode=true" class="flex center rd rd-weixin openqrcode"></a>
      <!--分享-->
